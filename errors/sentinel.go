...
// ErrRetryMaximumAttemptsReached indicates the maximum number of retry attempts was reached.
var ErrRetryMaximumAttemptsReached = register("retry_maximum_attempts_reached", "maximum retry attempts reached", nil)
